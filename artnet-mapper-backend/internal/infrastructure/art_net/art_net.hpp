...
namespace infrastructure {
    ...
    public:
        ...
        void Start();
        void Post(utility::SizedBufferPtr &&art_net_pixels);
        void Stop();
        ~ArtNet();
        ArtNet() = delete;
    ...
    private:
        ...
        void postPixels(utility::SizedBufferPtr &&art_net_pixels);
        ...
        std::queue<utility::SizedBufferPtr> _work_queue;
...
#endif //INFRASTRUCTURE_ART_NET_HPP
